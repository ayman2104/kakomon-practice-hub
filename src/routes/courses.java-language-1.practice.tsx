...
export const Route = createFileRoute("/courses/java-language-1/practice")({
  head: () => ({ meta: [{ title: "ランダム問題 | Java言語Ⅰ" }] }),
  component: Practice,
});
...
const ROUNDS = [
  { key: "第1回", label: "第1回", desc: "Javaの基本・変数" },
  { key: "第2回", label: "第2回", desc: "条件分岐・繰り返し・配列" },
  { key: "第3回", label: "第3回", desc: "クラスとメソッド" },
  { key: "第4回", label: "第4回", desc: "オブジェクト指向" },
  { key: "第5回", label: "第5回", desc: "継承" },
  { key: "第6回", label: "第6回", desc: "カプセル化・抽象クラス" },
  { key: "第7回", label: "第7回", desc: "総合演習" },
];
      ...
      <StudentShell>
        <div className="space-y-6">
          <div className="bg-card rounded-3xl shadow-[var(--shadow-card)] p-6 sm:p-8">
            ...
            <div className="text-xs text-primary font-medium">Java言語Ⅰ / ランダム問題</div>
