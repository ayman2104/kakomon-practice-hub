      ...
      <div className="space-y-6">
        <div className="bg-card rounded-3xl shadow-[var(--shadow-card)] p-6 sm:p-8">
          ...
          <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
            第8回〜第13回の範囲を練習します。ランダム問題で章ごとに確認し、試験準備では本番に近い順番で解きます。
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link
            to={"/courses/cpp-language-2/practice" as any}
            className="group bg-card rounded-3xl shadow-[var(--shadow-card)] p-5 min-h-[170px] hover:-translate-y-1 hover:shadow-lg transition flex flex-col justify-between"
          >
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
                  出題数・章（第8回〜第13回）・難易度を選んでランダムに練習できます。
                </p>
              </div>
            </div>

            <div className="flex items-center justify-between mt-5">
              <span className="text-sm text-muted-foreground">4択問題 / 章別</span>
          ...
          <Link
            to={"/courses/cpp-language-2/exams/shiken-junbi" as any}
            className="group bg-card rounded-3xl shadow-[var(--shadow-card)] p-5 min-h-[170px] hover:-translate-y-1 hover:shadow-lg transition flex flex-col justify-between"
          >
            <div className="space-y-3">
              <div className="h-10 w-10 rounded-2xl bg-primary/10 flex items-center justify-center text-xl">
              ...
              <div>
                <div className="text-xs text-primary font-medium">試験モード</div>
                <h2 className="text-xl font-bold mt-1">試験準備</h2>
                <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
                  第8回から第13回まで、章の順番どおりに本番っぽい問題を解きます。
                </p>
              </div>
            </div>

            <div className="flex items-center justify-between mt-5">
              <span className="text-sm text-muted-foreground">固定問題 / 順番出題</span>
              <span className="rounded-full bg-primary text-primary-foreground px-4 py-2 text-sm font-medium group-hover:opacity-90">
                開く →
              </span>
            </div>
