...
export const Route = createFileRoute("/courses/cpp-language-2/practice")({
  head: () => ({ meta: [{ title: "ランダム問題 | Ｃ++言語Ⅱ" }] }),
  component: Practice,
});
...
const ROUNDS = [
  { key: "第8回", label: "第8回", desc: "関数・参照・構造体" },
  { key: "第9回", label: "第9回", desc: "オーバーロード・クラス・コンストラクタ" },
  { key: "第10回", label: "第10回", desc: "継承・protected・初期化リスト" },
  { key: "第11回", label: "第11回", desc: "構造体ポインタ・new・virtual" },
  { key: "第12回", label: "第12回", desc: "抽象クラス・静的メンバ・Singleton" },
  { key: "第13回", label: "第13回", desc: "テンプレート関数・テンプレートクラス" },
];
      ...
      <StudentShell>
        <div className="space-y-6">
          <div className="bg-card rounded-3xl shadow-[var(--shadow-card)] p-6 sm:p-8">
            ...
            <div className="text-xs text-primary font-medium">Ｃ++言語Ⅱ / ランダム問題</div>
